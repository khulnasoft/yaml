...
import (
	...
	"go.khulnasoft.com/yaml/goyaml.v2"
)
...
//
//   - Decoding is case-insensitive, unlike the rest of Khulnasoft API machinery, as this is using the stdlib json library. This might be confusing to users.
