...
[![Build Status](https://travis-ci.org/khulnasoft-sigs/yaml.svg)](https://travis-ci.org/khulnasoft-sigs/yaml)

khulnasoft-sigs/yaml is a permanent fork of [ghodss/yaml](https://github.com/ghodss/yaml).
...
```
$ go get go.khulnasoft.com/yaml
```

And import using:

```
import "go.khulnasoft.com/yaml"
```
